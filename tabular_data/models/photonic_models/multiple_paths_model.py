        ...
        with tqdm(total=max_steps, desc="Training Progress", unit="step") as pbar:
            for step in range(max_steps):
                if (
                    ...
                    logging.warning(
                        "Reached max_train_time_seconds=%.1f. Stopping SKMultiplePathsModel training early at step %s.",
            ...
            append_long_training_event(
                timeout_events_path,
                {
                    **(timeout_events_metadata or {}),
                    ...
                    "reason": "Reached max_train_time_seconds during SKMultiplePathsModel fit.",
                    "model_name": self.model_name,
