...
class MultiplePathsModelClassifier(BaseEstimator, ClassifierMixin):
    def __init__(
        ...
        **kwargs,
        ...
        if self.n_classical_h_layers == 0 and len(self.num_neurons) > 0:
            self.n_classical_h_layers = len(self.num_neurons)
    ...
    def initialize_params(self):
        ...
        self.non_train_params_ = {"circuit_weights": circuit_weights}
...
class SKMultiplePathsModelReservoirGate(BaseEstimator, ClassifierMixin):
    """Scikit-learn compatible wrapper for the reservoir multiple paths model."""
    ...
    def __init__(self, data_params=None, model_params=None, training_params=None):
        ...
        self.model_name = "multiple_paths_model_reservoir"
