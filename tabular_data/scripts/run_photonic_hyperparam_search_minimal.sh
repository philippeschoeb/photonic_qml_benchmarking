...
declare -A MODEL_BACKENDS=(
  ["dressed_quantum_circuit"]="photonic"
  ["dressed_quantum_circuit_reservoir"]="photonic"
  ["multiple_paths_model"]="photonic"
  ["multiple_paths_model_reservoir"]="photonic"
  ["data_reuploading"]="photonic"
  ["q_kernel_method"]="photonic"
  ["q_kernel_method_reservoir"]="photonic"
  ["q_rks"]="photonic"
)
